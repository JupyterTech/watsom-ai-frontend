...
function TemplateSearch(props) {
  ...
  return (
    <div style={{textAlign: "-webkit-center"}} className="pt-8">
      <Card className="w-11/12 mx-10 text-center bg-sky-100 cursor-default relative">
        ...
        <TextInput
          ...
          className="w-5/6 lg:w-2/3 xl:w-1/2 self-center"
        />
        
        <div className='w-1/2 self-center bg-gray-100 rounded-lg absolute top-32'>
          {
