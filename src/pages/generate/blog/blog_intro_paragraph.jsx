...
import BlogIntroParagraph from '../../../components/Generate/Blog/BlogIntroParagraph';
        ...
        <div style={{width: " calc(100wh - 20rem) "}}>
          <div className='grid grid-cols-12'>
            <div className='col-span-5 border-gray-300 my-4 ml-8 bg-white' style={{borderWidth: "1px", borderRadius: '25px'}}>
              <Header 
                title={t("blog_intro_paragraph")}
                content={t("blog_intro_paragraph_content")}
              />
              <BlogIntroParagraph 
