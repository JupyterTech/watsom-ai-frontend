...
import FacebookAds from '../../../components/Generate/Ads/FacebookAds';
import { useTranslation } from "react-i18next";
import { openSnackBar } from '../../../redux/snackBarReducer';
import { useDispatch, useSelector } from "react-redux";
import { generateFacebookAds } from '../../../redux/template/ads';
  ...
  const generate = async (data, count, type, lang) => {
    if(!loading){
      ...
      if(is_valid){
        ...
        let res = await dispatch(generateFacebookAds(sendData));
        if(res != false){
          ...
          <div className='generate_body_main'>
            <div className='generate_input border-gray-300 my-4 ml-8 bg-white' style={{borderWidth: "1px", borderRadius: '25px'}}>
              <Header 
                ...
                content={t("facebook_ads_content")}
              />
              <FacebookAds 
