...
export const GPT_SERVER = DEV_MODE === true ? process.env.REACT_APP_LIVE_GPT_SERVER_LOCAL : process.env.REACT_APP_LIVE_GPT_SERVER_EC
export const API_BASE = DEV_MODE === true ? process.env.REACT_APP_LIVE_API_BASE_LOCAL : process.env.REACT_APP_LIVE_API_BASE_EC
